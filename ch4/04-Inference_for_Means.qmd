...
**Conclusion:** Both methods produce similar intervals. Neither the interval for "Closed" contains its hypothesized mean `r mu0[1]` using both methods.  The T2 CI  contains its hypothesized mean `r mu0[2]` while the Bonferroni CI does not contain its hypothesized mean `r mu0[2]`. Therefore, we conclude that 
