...
```{r}
#| code-summary: "R Code: Bart Chart"
...
```{r, message=FALSE}
#| code-summary: "R Code: Histograms with Different Bin Widths"
...
Side by side box plots and dot plots can be used to compare
distributions of a quantitative response variable for different levels of a categorical variable.

```{r}
#| code-summary: "R Code: Boxplots with Grouping"
...
```{r}
#| code-summary: "R Code: Scatterplot"
...
2. Create a combined `data.frame` and make a boxplot comparing the two groups.
...
```{r}
#| code-summary: "R Code: Grouping + Faceting" 
ggplot(tips, aes(x = bill, y = tip, color = sex)) +
  geom_point(alpha = 0.6) +
  geom_smooth(method = "lm", se = FALSE) +
  facet_grid(smoker ~ .) +
...
```{r}
#| code-summary: "R Code: Faceting Only" 
ggplot(tips, aes(x = bill, y = tip, color = sex)) +
  geom_point(alpha = 0.6) +
  geom_smooth(method = "lm", se = FALSE) +
...
```{r}
#| code-summary: "Scatterplot Matrix with Base R"
...
```{r}
#| code-summary: "R Code: Parallel Coordinates Plot"
