...
:::{.callout-warning title="Tips" collapse="true"}
...
| **What is Measured** | The discrepancy between the original metric distances ($d_{ij}$) and the final map distances ($\delta_{ij}$). | The discrepancy between the rank of map distances ($\delta_{ij}$) and the rank of original distances (${d}_{ij}$). |
